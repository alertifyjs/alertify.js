...
class Alertify {
     ...
     */
    public build(item: { type: string, message: string }) {
     ...
     * @return {undefined}
     */
    public close(elem: HTMLElement, wait: number) {
     ...
     * @return {Object}
     */
    public log(message: string, type: string, click) {
     ...
     * @return {undefined}
     */
    public notify(message: string, type: string, click) {
    ...
    public setDelay(time: string | number | null) {
        time = time || 0;
        this.delay = isNaN(time) ? this.defaultDelay : parseInt(time, 10);
        return this;
    }

    public cancelBtn(str: number) {
